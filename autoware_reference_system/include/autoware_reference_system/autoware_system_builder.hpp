...
#pragma GCC diagnostic ignored "-Wpedantic"
  ...
  nodes.emplace_back(
    ...
    #ifdef INTERNEURON
        ,.sensor_name = "EuclideanClusterSettings"
        #endif
    }));
  ...
  nodes.emplace_back(
    ...
    #ifdef INTERNEURON
        ,.sensor_names = {"FrontLidar","RearLidar"}
        #endif
    }));
  ...
  nodes.emplace_back(
    ...
    #ifdef INTERNEURON
        ,.sensor_names = {"FrontLidar","RearLidar","PointCloudMap","Visualizer","Lanelet2Map"}
        #endif
    }));
  ...
  nodes.emplace_back(
    ...
    #ifdef INTERNEURON
        ,.input_0_sensor_names = {"FrontLidar"},
        .input_1_sensor_names = {"RearLidar"},
        .output_sensor_names = {"FrontLidar","RearLidar"}
        #endif
    }));
  ...
  nodes.emplace_back(
    ...
    #ifdef INTERNEURON
        ,.input_0_sensor_names = {"FrontLidar","RearLidar"},
        .input_1_sensor_names = {"PointCloudMap"},
        .output_sensor_names = {"FrontLidar","RearLidar","PointCloudMap"}
        #endif
    }));
  ...
  nodes.emplace_back(
    ...
    #ifdef INTERNEURON
        ,.input_0_sensor_names = {"FrontLidar","RearLidar","PointCloudMap","Visualizer","Lanelet2Map"},
        .input_1_sensor_names = {"FrontLidar","RearLidar","PointCloudMap","Visualizer","Lanelet2Map"},
        .output_sensor_names = {"FrontLidar","RearLidar","PointCloudMap","Visualizer","Lanelet2Map"}
        #endif
    }));
  ...
  nodes.emplace_back(
    ...
    #ifdef INTERNEURON
        ,.input_0_sensor_names = {"Visualizer"},
        .input_1_sensor_names = {"FrontLidar","RearLidar","PointCloudMap"},
        .output_sensor_names = {"FrontLidar","RearLidar","PointCloudMap","Visualizer"}
        #endif
    }));
  ...
  nodes.emplace_back(
    ...
    #ifdef INTERNEURON
        ,.input_0_sensor_names = {"Lanelet2Map"},
        .input_1_sensor_names = {"FrontLidar","RearLidar","PointCloudMap","Visualizer"},
        .output_sensor_names = {"FrontLidar","RearLidar","PointCloudMap","Visualizer","Lanelet2Map"}
        #endif
    }));
  ...
  nodes.emplace_back(
    ...
    #ifdef INTERNEURON
        ,.input_sensor_names = {{ "FrontLidar","RearLidar" },
        { "FrontLidar","RearLidar","PointCloudMap" },
        { "FrontLidar","RearLidar","PointCloudMap","Visualizer" },
        { "FrontLidar","RearLidar","PointCloudMap","Visualizer","Lanelet2Map" },
        { "FrontLidar","RearLidar","PointCloudMap","Visualizer","Lanelet2Map" },
        { "FrontLidar","RearLidar","PointCloudMap","Visualizer","Lanelet2Map" }},
        .output_sensor_names = {"FrontLidar","RearLidar","PointCloudMap","Visualizer","Lanelet2Map"}
        #endif
  ...
  nodes.emplace_back(
    ...
    .output_sensor_names = {"FrontLidar","RearLidar"}
      ...
      {.input_topic = "EuclideanClusterSettings",
        ...
        #ifdef INTERNEURON
    ,.input_sensor_names = {"EuclideanClusterSettings"},
    .output_sensor_names = {"EuclideanClusterSettings"}
        #endif
        }}
        }));
  ...
  nodes.emplace_back(
    std::make_shared<typename SystemType::Command>(
      nodes::CommandSettings{.node_name = "IntersectionOutput",
        ...
        #ifdef INTERNEURON
        ,.sensor_names = {"EuclideanClusterSettings"}
        #endif
        }));
